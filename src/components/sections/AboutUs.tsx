...
const AboutUs = () => {
  return (
    <section id="about" className="relative bg-dark py-24 overflow-hidden">
      {/* Ambient glow, consistent with other sections */}
      <div
        className="absolute inset-0"
        style={{
          backgroundImage:
            "radial-gradient(circle at 15% 30%, rgba(253, 185, 19, 0.08) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-light/60 leading-relaxed mb-4">
        ...
        >
          <motion.div
            ...
            className="bg-light/5 border border-primary/15 rounded-2xl p-8 hover:border-primary/50 transition-colors duration-300"
          >
          ...
          >
            {values.map(({ icon: Icon, label }) => (
              <motion.div
                ...
                className="group flex items-center gap-3 bg-light/5 border border-primary/15 rounded-full px-6 py-3 hover:border-primary/50 hover:bg-primary/10 transition-all duration-300"
              >
