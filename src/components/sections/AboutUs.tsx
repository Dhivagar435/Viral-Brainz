...
const AboutUs = () => {
  return (
    <section id="about" className="relative bg-dark-900 py-24 overflow-hidden">
      <div
        className="absolute inset-0"
        style={{
          backgroundImage:
            "radial-gradient(circle at 15% 30%, var(--color-primary-100) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-light-70 text-lg leading-relaxed mb-4">
        ...
        >
          <motion.div
            ...
            className="bg-dark-800 border border-dark-700 rounded-2xl p-8 hover:border-primary/40 transition-colors duration-300"
          >
            <div className="w-12 h-12 rounded-xl bg-dark-700 border border-dark-700 flex items-center justify-center mb-5">
          ...
          >
            {values.map(({ icon: Icon, label }) => (
              <motion.div
                ...
                className="group flex items-center gap-3 bg-dark-800 border border-dark-700 rounded-full px-6 py-3 hover:border-primary/40 hover:bg-primary/10 transition-all duration-300"
              >
